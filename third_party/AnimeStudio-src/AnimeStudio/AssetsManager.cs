                ...
                foreach (var objectInfo in assetsFile.m_Objects)
                {
                    ...
                    try
                    {
                        Object obj = objectReader.type switch
                        {
                            ...
                            ClassIDType.ParticleSystem when ClassIDType.ParticleSystem.CanParse() => new ParticleSystemAsset(objectReader),
                            ClassIDType.ParticleSystemRenderer when ClassIDType.ParticleSystemRenderer.CanParse() => new ParticleSystemRendererAsset(objectReader),
